        ...
        public static async Task Seed(EquipmentContext context)
        {
            ...
            if (!await context.EquipmentItems.AnyAsync())
            {
                ...
                new Equipment
                {
                    ...
                    OwnerId = Guid.Parse("D8862A46-6E4B-438D-AFB2-BD9498B2E708"),
                    DateCreated = DateTime.UtcNow,
                    IsActive = true,
                 ...
                 new Equipment
                 {
                     ...
                     Status = RentStatusEnum.Rented,
                     InternalNotes = "Im renting fully working pc, without drives"
                 },
                 new Equipment
                 {
                     ...
                     RentalPricePerDay = 20,
                     Status = RentStatusEnum.Rented,
                     InternalNotes = "Im a test record !"
                 }
                );
            }
