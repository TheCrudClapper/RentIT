namespace ReviewServices.Core.ResultTypes
{
    public sealed record Error(int StatusCode, string Description)
    {
        ...
        public static readonly Error UpdateFailed = new(422, "Update of given resource failed");
        public static readonly Error DeleteFailed = new(422, "Deletion of given resource failed");
